...
public class ObjectGenerator implements Json.Serializable {
    ...
    public Array<Orbiter> createMoons() {
        ...
        ColorGroup colors = new ColorGroup().add(Color.rgba8888(176f / 255f, 155f / 255f, 178f / 255f, 1f))
        ...
        for (int i = 0; i < moonCount; i++) {
            ...
            Orbiter moon = new Orbiter(createMoonSprite(MathUtils.random(16, 20) / (moonCount / 3 + 1)), moonBlueprint,
                    color);
            moons.add(moon);
        }
    ...
    public Array<Ring> createRings() {
        ...
        colors.add(new ColorGroup().add(Color.rgba8888(223f / 255f, 233f / 255f, 180f / 255f, 1f))
                .add(Color.rgba8888(170f / 255f, 90f / 255f, 103f / 255f, 1f)));

        colors.add(new ColorGroup().add(Color.rgba8888(191f / 255f, 231f / 255f, 231f / 255f, 1f))
                .add(Color.rgba8888(75f / 255f, 109f / 255f, 133f / 255f, 1f)));

        colors.add(new ColorGroup().add(Color.rgba8888(169f / 255f, 194f / 255f, 175f / 255f, 1f))
    ...
    public Ring createRing(Ring ring) {
        ...
        float minimumRadius = innerRing == null ? scene.getPlanet().getWidthAtY(0) + 25
                : innerRing.getMaximumRadius() + 5;
        float maximumRadius = innerRing == null ? minimumRadius + MathUtils.random(20, 60)
                : minimumRadius + MathUtils.random(20, 50);
        ColorGroup colorGroup = colors.random();
    ...
    public Orbiter createObjectInRing(Ring ring) {
        ...
        Orbiter ringObject = new Orbiter(createMoonSprite(MathUtils.random(4, 6)), blueprint,
                ring.getColors().random());
    ...
    public Array<Cloud> createClouds(int color) {
        ...
        for (int i = 0; i < cloudCount; i++) {
            ...
            for (int j = 0; j < clusterCount; j++) {
                ...
                cloudBlueprint.radius = scene.getPlanet().getMinimumCloudRadiusAtY(cloudBlueprint.yOffset)
                        + MathUtils.random(0, 6);
    ...
    public Cloud createCloud(float velocity, Color color) {
        ...
        for (int i = 0; i < clusterCount; i++) {
            ...
            Orbiter cloud = new Orbiter(createMoonSprite(MathUtils.random(5, 8)), cloudBlueprint,
    ...
    public Array<Star> createStars(int starAmount) {
        ...
        for (int i = 0; i < starAmount; i++) {
            ...
            star.setPosition(MathUtils.random(0, Scene.BUFFER_WIDTH + Scene.EDITOR_OFFSET),
                    MathUtils.random(0, Scene.BUFFER_HEIGHT));
