...
public class RingEditor extends ObjectEditor {
    ...
    public RingEditor(final Scene scene, String objectName, final Ring ring) {
        ...
        minRadiusSlider = createSlider("Min. Radius", radiusMin, 400, zeroSnap, ring.getMinimumRadius(),
                new ChangeListener() {
                    @Override
                    public void changed(ChangeEvent event, Actor actor) {
                        if (shouldFireChange) {
        ...
        maxRadiusSlider = createSlider("Max. Radius", radiusMin, 400, zeroSnap, ring.getMaximumRadius(),
                new ChangeListener() {
                    @Override
                    public void changed(ChangeEvent event, Actor actor) {
                        if (shouldFireChange) {
